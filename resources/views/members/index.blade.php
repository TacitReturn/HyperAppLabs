            ...
            <ul class="nav nav-navbar">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../page/pricing.html">Pricing</a>
                        </li>
                            ...
                            <div class="card text-center shadow-1 hover-shadow-9">
                                ...
                                <div class="card-body py-6">
                                    <p class="lead-7 fw-600 text-dark">
                                        <span data-bind-radio="pricing-6" data-monthly="$6." data-yearly="$60.">$6.</span><span class="lead-4 align-text-top">99</span></p>
                                    <p>
                                        Single Website<br>
                                        60GB Bandwidth<br>
                                        Manual Import<br>
                        ...
                        <div class="col-md-6">
                            <div class="card text-center shadow-1 hover-shadow-9">
                                <div class="card-img-top text-white bg-img h-200 d-flex align-items-center" style="background-image: url(../assets/img/thumb/11.jpg)" data-overlay="2">
                                    <div class="position-relative w-100">
                                        <p class="lead-4 text-uppercase fw-600 ls-1 mb-0">Business</p>
                                        <p><span data-bind-radio="pricing-6" data-monthly="Monthly" data-yearly="Yearly">Monthly</span> Package</p>
                                    </div>
                                </div>
                                <div class="card-body py-6">
                                    <p class="lead-7 fw-600 text-dark">
                                        <span data-bind-radio="pricing-6" data-monthly="$18." data-yearly="$180.">$18.</span><span class="lead-4 align-text-top">99</span>
                                    <p>
                                        7 Website<br>
                                    ...
                                    <br>
                                    <div><a class="btn btn-round btn-secondary w-200" href="#">Sign up</a></div>
                                </div>
                            </div>
                        </div>
